...
def build_post_content(job):
    """채용공고 HTML 본문 생성"""
    apply_html = (
        f'<a href="{job["apply_link"]}" target="_blank">지원하러 가기</a>'
        if job['apply_link']
        else '상세 문의는 댓글로 남겨주세요.'
    )
...
<tr style="background-color: #f0f0f0;">
  <th style="width: 25%;">항목</th><th>내용</th>
</tr>
<tr><td><strong>🏢 기업명</strong></td><td>{job['company']}</td></tr>
<tr><td><strong>💼 모집분야</strong></td><td>{job['position']}</td></tr>
<tr><td><strong>📋 담당업무</strong></td><td>{job['duty']}</td></tr>
<tr><td><strong>⏰ 마감일</strong></td><td style="color: #d9534f;"><strong>{job['deadline']}</strong></td></tr>
</table>
<hr>
<p><strong>🔗 채용 지원:</strong> {apply_html}</p>
